...
```bash
Trên điện thoại các bạn tải cho mình [SetEdit (Settings Database Editor)](https://play.google.com/store/apps/details?id=by4a.setedit22&hl=en)https://play.google.com/store/apps/details?id=by4a.setedit22&hl=en)
```
